...
def setup_openai(env):
    ...
    if env == "Cartpole":
        ...
        # Agent parameters
        layer_function = ["Step"]
        weights = [0.7899999999999996, 5.364440394181111, -4.281379274808872, 13.014957106392535, -3.875294689295202]
        alpha = 0.76
...
def main():
    # TODO Generalize networks (inheritance)
#    mlp()
#    perceptron()
    
    setup_openai("Cartpole")
